...
1. Install version 0.1.5 (version code 6) over the existing app. Do not uninstall
...
1. Only after every Android installation is on version code 6 or newer, set the
