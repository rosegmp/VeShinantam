...
- `docs` — product specification, wireframes, Android roadmap, [web parity roadmap](docs/WEB_PARITY_ROADMAP.md), [parity matrix](docs/WEB_PARITY_MATRIX.md), and [browser QA matrix](docs/WEB_BROWSER_QA.md)
